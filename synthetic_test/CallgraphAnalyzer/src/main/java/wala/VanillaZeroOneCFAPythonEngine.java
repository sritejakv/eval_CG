...
/**
 * Wala python engine to generate Vanilla-0-1-CFA call graph.
 */
public class VanillaZeroOneCFAPythonEngine extends PythonAnalysisEngine<Void> {

    static {
        try {
            Class<?> j3 = Class.forName("com.ibm.wala.cast.python.loader.Python3LoaderFactory");
            VanillaZeroOneCFAPythonEngine.setLoaderFactory((Class<? extends PythonLoaderFactory>) j3);
            ...
            try {
                ...
                VanillaZeroOneCFAPythonEngine.setLoaderFactory((Class<? extends PythonLoaderFactory>) j2);
    ...
    public VanillaZeroOneCFAPythonEngine(){
        super();
    }
    ...
    protected PythonSSAPropagationCallGraphBuilder getCallGraphBuilder(IClassHierarchy cha, AnalysisOptions options, IAnalysisCacheView cache2) {
        ...
        //From com.ibm.wala.ipa.callgraph.impl.Util.java::445 -> com.ibm.wala.ipa.callgraph.propagation.cfa.ZeroXCFABuilder::40
