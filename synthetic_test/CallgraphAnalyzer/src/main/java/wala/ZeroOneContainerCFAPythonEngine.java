...
/**
 * Wala python engine to generate 0-1-Container-CFA call graph.
 */
public class ZeroOneContainerCFAPythonEngine extends PythonAnalysisEngine<Void> {

    static {
        try {
            Class<?> j3 = Class.forName("com.ibm.wala.cast.python.loader.Python3LoaderFactory");
            ZeroOneContainerCFAPythonEngine.setLoaderFactory((Class<? extends PythonLoaderFactory>) j3);
            ...
            try {
                ...
                ZeroOneContainerCFAPythonEngine.setLoaderFactory((Class<? extends PythonLoaderFactory>) j2);
    ...
    public ZeroOneContainerCFAPythonEngine() {
        super();
    }
    ...
    protected PythonSSAPropagationCallGraphBuilder getCallGraphBuilder(IClassHierarchy cha, AnalysisOptions options, IAnalysisCacheView cache2) {
        ...
        //From com.ibm.wala.ipa.callgraph.impl.Util.java::makeZeroOneContainerCFABuilder::520 -> com.ibm.wala.ipa.callgraph.propagation.cfa.ZeroXContainerCFABuilder::51
        //Removing ZeroXInstanceKeys.SMUSH_PRIMITIVE_HOLDERS and ZeroXInstanceKeys.SMUSH_THROWABLES as they are not
        //handled for Python language in WALA.
        ContextSelector CCS = new ContainerContextSelector(cha, new ZeroXInstanceKeys(options, cha, interpreter,
                ZeroXInstanceKeys.ALLOCATIONS
                        | ZeroXInstanceKeys.SMUSH_MANY
                        | ZeroXInstanceKeys.SMUSH_STRINGS));
        DelegatingContextSelector DCS = new DelegatingContextSelector(CCS, new DefaultContextSelector(options, cha));
        builder.setContextSelector(DCS);
        ...
        builder.setInstanceKeys(new PythonScopeMappingInstanceKeys(builder, new ZeroXInstanceKeys(
                ...
                ZeroXInstanceKeys.ALLOCATIONS
                        | ZeroXInstanceKeys.SMUSH_MANY
                        | ZeroXInstanceKeys.SMUSH_STRINGS))); //From com.ibm.wala.ipa.callgraph.impl.Util.java::makeZeroOneContainerCFABuilder::540
