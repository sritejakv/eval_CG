...
/**
 * Wala python engine to generate 0-1-CFA call graph.
 */
public class ZeroOneCFAPythonEngine extends PythonAnalysisEngine<Void> {

    static {
        try {
            Class<?> j3 = Class.forName("com.ibm.wala.cast.python.loader.Python3LoaderFactory");
            ZeroOneCFAPythonEngine.setLoaderFactory((Class<? extends PythonLoaderFactory>) j3);
            ...
            try {
                ...
                ZeroOneCFAPythonEngine.setLoaderFactory((Class<? extends PythonLoaderFactory>) j2);
    ...
    protected PythonSSAPropagationCallGraphBuilder getCallGraphBuilder(IClassHierarchy cha, AnalysisOptions options, IAnalysisCacheView cache2) {
        ...
        //From com.ibm.wala.ipa.callgraph.impl.Util.java::makeZeroOneCFABuilder::396 -> com.ibm.wala.ipa.callgraph.propagation.cfa.ZeroXCFABuilder::40
        ...
        builder.setInstanceKeys(new PythonScopeMappingInstanceKeys(builder, new ZeroXInstanceKeys(
                ...
                ZeroXInstanceKeys.ALLOCATIONS
                        ...
                        | ZeroXInstanceKeys.SMUSH_STRINGS)));//From com.ibm.wala.ipa.callgraph.impl.Util.java::makeZeroOneCFABuilder::479
