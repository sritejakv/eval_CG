...
/**
 * Wala python engine to generate 0-Container-CFA call graph.
 */
public class ZeroContainerCFAPythonEngine extends PythonAnalysisEngine<Void> {

    static {
        try {
            Class<?> j3 = Class.forName("com.ibm.wala.cast.python.loader.Python3LoaderFactory");
            ZeroContainerCFAPythonEngine.setLoaderFactory((Class<? extends PythonLoaderFactory>) j3);
            ...
            try {
                ...
                ZeroContainerCFAPythonEngine.setLoaderFactory((Class<? extends PythonLoaderFactory>) j2);
    ...
    public ZeroContainerCFAPythonEngine() {
        super();
    }
    ...
    protected PythonSSAPropagationCallGraphBuilder getCallGraphBuilder(IClassHierarchy cha, AnalysisOptions options, IAnalysisCacheView cache2) {
        ...
        //From com.ibm.wala.ipa.callgraph.impl.Util.java::makeZeroContainerCFABuilder::493 -> com.ibm.wala.ipa.callgraph.propagation.cfa.ZeroXContainerCFABuilder::51
        ...
        builder.setInstanceKeys(new PythonScopeMappingInstanceKeys(builder, new ZeroXInstanceKeys(
                ...
                cha,
                interpreter,
                ZeroXInstanceKeys.NONE))); //From com.ibm.wala.ipa.callgraph.impl.Util.java::makeZeroContainerCFABuilder::505
